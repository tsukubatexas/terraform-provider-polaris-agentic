...
Generate `internal/generated/operations_gen.go` and `docs/generated-operations.md` from Apache Polaris release-tagged OpenAPI specs.
...
- Generated files must not be hand-edited. Fix the generator or spec input handling instead.
